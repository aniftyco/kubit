declare module '@ioc:Kubit/Container' {
   ...
   */
  type BindCallback<ReturnValue extends any, Container extends IocContract> = (container: Container) => ReturnValue;
  /**
  ...
  interface IocContract<ContainerBindings extends any = any> {
    ...
    bind<Binding extends string>(
      binding: Binding,
      callback: BindCallback<Binding extends keyof ContainerBindings ? ContainerBindings[Binding] : any, this>
    ): this;
    /**
    ...
    fake<Namespace extends string>(
      namespace: Namespace,
      callback: FakeCallback<Namespace extends keyof ContainerBindings ? ContainerBindings[Namespace] : any, this>
    ): this;
    /**
  ...
  interface IocResolverContract<ContainerBindings extends any> {
    ...
    resolve<Namespace extends string>(
      namespace: Namespace,
      prefixNamespace?: string
    ): Namespace extends keyof ContainerBindings ? IocResolverLookupNode<Namespace> : IocResolverLookupNode<string>;
    /**
