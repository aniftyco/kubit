declare module '@ioc:Kubit/Lucid/Orm' {
  import {
    ChainableContract,
    OneOrMany,
    QueryCallback,
   ...
   */
  export interface HasOneRelationContract<ParentModel extends LucidModel, RelatedModel extends LucidModel>
   ...
   */
  export interface HasManyRelationContract<ParentModel extends LucidModel, RelatedModel extends LucidModel>
    extends BaseRelationContract<ParentModel, RelatedModel> {
   ...
   */
  export interface BelongsToRelationContract<ParentModel extends LucidModel, RelatedModel extends LucidModel>
    extends BaseRelationContract<ParentModel, RelatedModel> {
   ...
   */
  export interface ManyToManyRelationContract<ParentModel extends LucidModel, RelatedModel extends LucidModel>
    extends BaseRelationContract<ParentModel, RelatedModel> {
    type: 'manyToMany';
   ...
   */
  export interface HasManyThroughRelationContract<ParentModel extends LucidModel, RelatedModel extends LucidModel>
    extends BaseRelationContract<ParentModel, RelatedModel> {
    type: 'hasManyThrough';
    readonly localKey: string;
    readonly foreignKey: string;
   ...
   */
  export interface HasOneClientContract<Relation extends RelationshipsContract, RelatedModel extends LucidModel>
   ...
   */
  export interface HasManyClientContract<Relation extends RelationshipsContract, RelatedModel extends LucidModel>
   ...
   */
  export interface BelongsToClientContract<Relation extends RelationshipsContract, RelatedModel extends LucidModel>
    extends RelationQueryClientContract<Relation, RelatedModel> {
    /**
   ...
   */
  export interface ManyToManyClientContract<Relation extends RelationshipsContract, RelatedModel extends LucidModel>
    extends RelationQueryClientContract<Relation, RelatedModel> {
    /**
   ...
   * for that.
   */
  export interface HasManyThroughClientContract<Relation extends RelationshipsContract, RelatedModel extends LucidModel>
    extends RelationQueryClientContract<Relation, RelatedModel> {
    /**
     * Return a query builder instance of the relationship
     */
