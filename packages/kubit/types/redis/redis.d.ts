...
declare module '@ioc:Kubit/Redis' {
  ...
  */
  ...
  type GetConnectionFactoryType<T extends keyof RedisConnectionsList> =
    RedisConnectionsList[T] extends RedisClusterConfig ? RedisClusterConnectionContract : RedisConnectionContract;
  ...
  */
  ...
  export interface RedisBaseManagerContract {
     ...
     */
    disconnect<ConnectionName extends keyof RedisConnectionsList>(name?: ConnectionName): Promise<void>;
