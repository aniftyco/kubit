declare module '@ioc:Kubit/Validator' {
  ...
  export type AsyncValidation<T extends any = unknown> = {
    compile(type: NodeType, subtype: NodeSubType, options?: any, rulesTree?: { [key: string]: any }): ParsedRule<T>;
  ...
  */
  ...
  export type ValidatorConfig = {
    ...
    reporter?: () => Promise<ErrorReporterConstructorContract> | Promise<{ default: ErrorReporterConstructorContract }>;
  };
