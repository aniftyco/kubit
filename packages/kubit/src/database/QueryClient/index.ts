...
export class QueryClient implements QueryClientContract {
   ...
   * The dialect in use
   */
  public dialect: DialectContract = new dialects[this.connection.dialectName](this, this.connection.config);
  ...
  public async transaction(
    callback?: { isolationLevel?: IsolationLevels } | ((trx: TransactionClientContract) => Promise<any>),
  ...
  public modelQuery(model: any): any {
    return new ModelQueryBuilder(this.knexQuery(), model, this as any);
  }
