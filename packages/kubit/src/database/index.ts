...
export class Database extends Macroable implements DatabaseContract {
   ...
   */
  public Database = Database as any;
  ...
  public transaction(
    ...
    return typeof callback === 'function' ? client.transaction(callback, options) : client.transaction(callback);
  }
   ...
   */
  public async beginGlobalTransaction(connectionName?: string, options?: Omit<DatabaseClientOptions, 'mode'>) {
