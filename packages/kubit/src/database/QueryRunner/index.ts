...
export class QueryRunner {
  private reporter = new QueryReporter(this.client as any, this.debug, this.logData);
   ...
   * gracefully.
   */
  private async executeQuery(query: Knex.QueryBuilder | Knex.Raw): Promise<[Error | undefined, any | undefined]> {
    try {
