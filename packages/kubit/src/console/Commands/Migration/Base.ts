...
import { prettyPrint } from '../../../database/Helpers/prettyPrint';
import { getDDLMethod } from '../../../database/utils';
import { BaseCommand } from '../../BaseCommand';

/**
 * Base class to execute migrations and print logs
 */
export abstract class MigrationsBase extends BaseCommand {
  /**
   ...
   */
  private logCompactFinalStatus(processedFiles: Set<string>, migrator: MigratorContract, duration?: [number, number]) {
    let output = '';
    let message = '';
