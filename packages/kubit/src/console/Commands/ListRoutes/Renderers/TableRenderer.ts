...
export class RoutesTableRenderer extends BaseRender {
  ...
  private getMethodsColumnWidth(columnSize: number) {
    return columnSize < 15 ? { size: columnSize, leftOver: 0 } : { size: 15, leftOver: columnSize - 15 };
  }
  ...
  private getTable() {
    ...
    return this.command.ui
      ...
      .columnWidths([this.columns.methodsColumnSize, this.columns.patternColumnSize, this.columns.handlerColumnSize]);
  }
