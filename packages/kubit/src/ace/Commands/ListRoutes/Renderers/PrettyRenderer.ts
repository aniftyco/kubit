import { ListRoutes, SerializedRoute } from '../index';
...
export class RoutesPrettyRenderer extends BaseRender {
   ...
   */
  private outputRoute(route: SerializedRoute, renderingOptions: { spaces: string; dashes: string }) {
   ...
   * route handler
   */
  private getRenderingWidths(methods: string, spaces: string, pattern: string, nameAndHandler: string) {
