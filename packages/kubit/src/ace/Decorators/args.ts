import { ArgTypes, CommandArg, CommandConstructorContract } from '../Contracts';

/**
 * Adds arg to the list of command arguments with pre-defined
 * type.
 */
function addArg<PropType extends any>(type: ArgTypes, options: Partial<Omit<CommandArg, 'type' | 'propertyName'>>) {
