 ...
 * types.
 */
function addFlag<T extends any>(type: FlagTypes, options: Partial<Omit<CommandFlag, 'propertyName' | 'type'>>) {
  return function flag<TKey extends string, TTarget extends { [K in TKey]: T }>(target: TTarget, propertyName: TKey) {
