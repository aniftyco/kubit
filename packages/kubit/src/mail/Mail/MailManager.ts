  ...
  implements MailManagerContract
{
  ...
  public emitter = this.app.container.use('Kubit/Event');
  public logger = this.app.container.use('Kubit/Logger');
  public profiler = this.app.container.use('Kubit/Profiler');
