...
import { FakeDriverContract, FakeMailResponse, MessageNode, MessageSearchNode } from '@ioc:Kubit/Mail';
...
export class FakeDriver implements FakeDriverContract {
   ...
   * Find an email
   */
  public find(messageOrCallback: MessageSearchNode | ((mail: MessageSearchNode) => boolean)): MessageNode | null {
