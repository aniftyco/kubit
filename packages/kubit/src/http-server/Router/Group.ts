...
export class RouteGroup extends Macroable implements RouteGroupContract {
   ...
   * resource instance
   */
  private invoke(route: Route | RouteResource | BriskRoute | RouteGroup, method: string, params: any[]) {
   ...
   * ```
   */
  public middleware(middleware: RouteMiddlewareHandler | RouteMiddlewareHandler[], prepend: boolean = false): this {
