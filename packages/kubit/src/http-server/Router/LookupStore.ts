...
import { LookupStoreContract, LookupStoreTree, RouteJSON, UrlBuilderContract } from '@ioc:Kubit/Route';
...
export class UrlBuilder implements UrlBuilderContract {
   ...
   * Generate url for the given route identifier
   */
  public makeSigned(identifier: string, options?: { expiresIn?: string | number; purpose?: string }) {
    let url: string;
