...
import { CurrencyFormatOptions, FormatterContract, NumberFormatOptions, TimeFormatOptions } from '@ioc:Kubit/I18n';
...
export class Formatter implements FormatterContract {
   ...
   */
  private getTimeDiff(value: string | number | Date | DateTime, unit: Intl.RelativeTimeFormatUnit | 'auto'): number {
   ...
   */
  public formatDate(value: string | number | Date | DateTime, options?: Intl.DateTimeFormatOptions) {
