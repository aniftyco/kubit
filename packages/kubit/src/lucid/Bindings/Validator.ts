...
import { DatabaseContract, DatabaseQueryBuilderContract } from '@ioc:Kubit/Lucid/Database';
import { DbRowCheckOptions, ValidationRuntimeOptions, validator as validatorStatic } from '@ioc:Kubit/Validator';
 ...
 */
export function extendValidator(validator: typeof validatorStatic, database: DatabaseContract, logger: LoggerContract) {
  /**
