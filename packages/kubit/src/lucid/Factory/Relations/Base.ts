...
export abstract class BaseRelation {
  ...
  constructor(private factory: () => FactoryBuilderQueryContract<FactoryModelContract<LucidModel>>) {}

  /**
   * Instantiates the relationship factory
   */
  protected compile(relation: FactoryRelationContract, parent: LucidRow, callback?: RelationCallback) {
    this.parent = parent;
