...
import { ExtractModelRelations, LucidModel, ModelAdapterOptions, RelationshipsContract } from '@ioc:Kubit/Lucid/Orm';
...
export class FactoryModel<Model extends LucidModel> implements FactoryModelContract<Model> {
   ...
   */
  public newUpModelInstance: NewUpCallback<FactoryModelContract<LucidModel>> = (attributes, _, model) => {
    /**
