...
import { ConnectionConfig, ConnectionContract, ReportNode } from '@ioc:Kubit/Lucid/Database';
...
export class Connection extends EventEmitter implements ConnectionContract {
   ...
   */
  public dialectName: ConnectionContract['dialectName'] = resolveClientNameWithAliases(this.config.client);
