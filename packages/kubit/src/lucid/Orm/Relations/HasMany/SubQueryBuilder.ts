...
import { LucidModel, RelationSubQueryBuilderContract } from '@ioc:Kubit/Lucid/Orm';

import { BaseSubQueryBuilder } from '../Base/SubQueryBuilder';
import { HasMany } from './index';

export class HasManySubQueryBuilder extends BaseSubQueryBuilder implements RelationSubQueryBuilderContract<LucidModel> {
