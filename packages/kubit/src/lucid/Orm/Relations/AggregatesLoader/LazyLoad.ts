...
import { LazyLoadAggregatesContract, LucidModel, LucidRow, ModelQueryBuilderContract } from '@ioc:Kubit/Lucid/Orm';

/**
 * An implementation for lazy loading model relationship aggregates
 */
export class LazyLoadAggregates<Model extends LucidRow> implements LazyLoadAggregatesContract<Model> {
