...
import { AdapterContract, LucidModel, LucidRow, ModelAdapterOptions } from '@ioc:Kubit/Lucid/Orm';
...
export class Adapter implements AdapterContract {
  ...
  public async refresh(instance: LucidRow) {
    ...
    const freshModelInstance = await instance.$getQueryFor('refresh', this.modelClient(instance)).first();
