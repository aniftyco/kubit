 ...
 */
const validate = <T extends ParsedTypedSchema<TypedSchema>>(validator: ValidatorNode<T>): Promise<T['props']> => {
  /**
...
const rule = (
  ...
  compileFn?: (options: any[], nodeType: NodeType, subtype: NodeSubType) => Partial<ParsedRule<any>>,
