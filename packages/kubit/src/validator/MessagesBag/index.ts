import { CustomMessages, MessagesBagContract } from '@ioc:Kubit/Validator';
...
export class MessagesBag implements MessagesBagContract {
  private wildCardCallback = typeof this.messages['*'] === 'function' ? this.messages['*'] : undefined;
   ...
   */
  public get(pointer: string, rule: string, message: string, arrayExpressionPointer?: string, args?: any) {
