import { SchemaObject, ValidationField } from '@ioc:Kubit/Validator';
...
export class ObjectCompiler {
   ...
   */
  private declareOutVariable(buffer: CompilerBuffer, outVariable: string, outValue: string, constAssigment: boolean) {
