...
string.optional = function optionalString(options?: { escape?: boolean; trim?: boolean } | Rule[], rules?: Rule[]) {
  if (!rules && Array.isArray(options)) {
    rules = options;
    options = {};
  }
  return getLiteralType('string', true, false, options, rules || []) as ReturnType<StringType['optional']>;
};
string.nullable = function nullableString(options?: { escape?: boolean; trim?: boolean } | Rule[], rules?: Rule[]) {
  if (!rules && Array.isArray(options)) {
    rules = options;
    options = {};
  }
  return getLiteralType('string', false, true, options, rules || []) as ReturnType<StringType['nullable']>;
};
string.nullableAndOptional = function nullableAndOptionalString(
  ...
  return getLiteralType('string', true, true, options, rules || []) as ReturnType<StringType['nullableAndOptional']>;
};
...
boolean.optional = function optionalBoolean(rules?: Rule[]) {
  return getLiteralType('boolean', true, false, undefined, rules || []) as ReturnType<BooleanType['optional']>;
};
boolean.nullable = function nullableBoolean(rules?: Rule[]) {
  return getLiteralType('boolean', false, true, undefined, rules || []) as ReturnType<BooleanType['nullable']>;
};
...
number.optional = function optionalNumber(rules?: Rule[]) {
  return getLiteralType('number', true, false, undefined, rules || []) as ReturnType<NumberType['optional']>;
};
number.nullable = function nullableNumber(rules?: Rule[]) {
  return getLiteralType('number', false, true, undefined, rules || []) as ReturnType<NumberType['nullable']>;
};
number.nullableAndOptional = function nullableAndOptionalNumber(rules?: Rule[]) {
  return getLiteralType('number', true, true, undefined, rules || []) as ReturnType<NumberType['nullableAndOptional']>;
};
...
date.optional = function optionalDate(options?: { format: string }, rules?: Rule[]) {
  return getLiteralType('date', true, false, options, rules || []) as ReturnType<DateType['optional']>;
};
date.nullable = function nullableDate(options?: { format: string }, rules?: Rule[]) {
  return getLiteralType('date', false, true, options, rules || []) as ReturnType<DateType['nullable']>;
};
date.nullableAndOptional = function nullableAndOptionalDate(options?: { format: string }, rules?: Rule[]) {
  return getLiteralType('date', true, true, options, rules || []) as ReturnType<DateType['nullableAndOptional']>;
};
...
oneOf.optional = function optionalEnum(enumOptions: any[], rules?: Rule[]) {
  return getLiteralType('enum', true, false, enumOptions, rules || []) as ReturnType<EnumType['optional']>;
};
oneOf.nullable = function nullableEnum(enumOptions: any[], rules?: Rule[]) {
  return getLiteralType('enum', false, true, enumOptions, rules || []) as ReturnType<EnumType['nullable']>;
};
oneOf.nullableAndOptional = function nullableAndOptionalEnum(enumOptions: any[], rules?: Rule[]) {
  return getLiteralType('enum', true, true, enumOptions, rules || []) as ReturnType<EnumType['nullableAndOptional']>;
};
...
function enumSet(enumOptions: any[], rules?: Rule[]) {
  return getLiteralType('enumSet', false, false, enumOptions, rules || []) as ReturnType<EnumSetType>;
}
enumSet.optional = function optionalEnumSet(enumOptions: any[], rules?: Rule[]) {
  return getLiteralType('enumSet', true, false, enumOptions, rules || []) as ReturnType<EnumSetType['optional']>;
};
enumSet.nullable = function nullableEnumSet(enumOptions: any[], rules?: Rule[]) {
  return getLiteralType('enumSet', false, true, enumOptions, rules || []) as ReturnType<EnumSetType['nullable']>;
};
enumSet.nullableAndOptional = function nullableAndOptionalEnumSet(enumOptions: any[], rules?: Rule[]) {
...
file.optional = function optionalFile(options: any, rules?: Rule[]) {
  return getLiteralType('file', true, false, options, rules || []) as ReturnType<FileType['optional']>;
};
file.nullable = function nullableFile(options: any, rules?: Rule[]) {
  return getLiteralType('file', false, true, options, rules || []) as ReturnType<FileType['nullable']>;
};
file.nullableAndOptional = function nullableAndOptionalFile(options: any, rules?: Rule[]) {
  return getLiteralType('file', true, true, options, rules || []) as ReturnType<FileType['nullableAndOptional']>;
};
