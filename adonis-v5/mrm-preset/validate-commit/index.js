...
function task() {
  ...
  const commitFile = lines('.husky/commit-msg')
    ...
    .add('HUSKY_GIT_PARAMS=$1 node ./node_modules/@kubit/mrm-preset/validate-commit/conventional/validate.js');
  ...
  pkgFile.unset(
    ...
    'node ./node_modules/@kubit/mrm-preset/validateCommit/conventional/validate.js'
  );
